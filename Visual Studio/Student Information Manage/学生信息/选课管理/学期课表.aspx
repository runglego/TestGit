<%@ Page Language="C#" AutoEventWireup="true" CodeFile="学期课表.aspx.cs" Inherits="学生信息_选课管理_学期课表" %>
...
<body>
  <section class="hbox stretch">
    ...
    <section id="content">
      ...
      <table>
      <thead>
      <tr><th align="center" width="300" class="style5"></th>
          <th width="300" align="center" class="style5">星期一</th>
          <th width="300" align="center" class="style5">星期二</th>
          <th width="300"  align="center" class="style5">星期三</th>
          <th width="300" align="center" class="style5">星期四</th>
          <th width="300" align="center" class="style5">星期五</th>
          <th width="300" align="center" class="style5">星期六</th>
          <th width="300" align="center" class="style5">星期日</th></tr>
       </thead>
       </table>
<asp:DataList ID="DataList1" runat="server" Height="300" >
    ...
    <tbody>
    <tr>
    <td width="300"><%#Eval("第几节") %></td>
    <td width="300"><%#Eval("星期一") %></td>
    <td width="300"><%#Eval("星期二") %></td>
    <td width="300"><%#Eval("星期三") %></td>
    <td width="300"><%#Eval("星期四") %></td>
    <td width="300"><%#Eval("星期五") %></td>
    <td width="300"><%#Eval("星期六") %></td>
    <td width="300"><%#Eval("星期日") %></td>
    </tr>
    </tbody>
    </table>
    </ItemTemplate>

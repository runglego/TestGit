<%@ Page Language="C#" AutoEventWireup="true" CodeFile="学位课绩点.aspx.cs" Inherits="学生信息_学生成绩_学位课绩点" %>
  ...
  <section class="hbox stretch">
    ...
    <section id="content">
      <section class="vbox">
        ...
        <br /><br /><br /><br />
        <b style="font-size: x-large">您的学位课绩点=<asp:Label ID="绩点" runat="server" Text=""></asp:Label></b>
    </section>

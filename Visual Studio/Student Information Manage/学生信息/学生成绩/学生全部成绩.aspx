<%@ Page Language="C#" AutoEventWireup="true" CodeFile="学生全部成绩.aspx.cs" Inherits="学生信息_学生成绩_学生全部成绩" %>
  ...
  <section class="hbox stretch">
          ...
          <nav class="nav-primary hidden-xs">
            <ul class="nav">
              ...
              <li class="dropdown-submenu">
                ...
                <ul class="dropdown-menu">                
                  <li>
                    <a href="学生全部成绩.aspx">学生全部成绩</a>
                  </li>
                  <li>
                    <a href="学位课绩点.aspx">学位课绩点</a>
                  </li>
                </ul>
              </li>
            </ul>
    ...
    <section id="content">
      <section class="vbox">
       ...
       <table>
      <thead>
      <tr><th align="center" width="300" class="style5">学期</th>
          <th width="300" align="center" class="style5">课程名</th>
          <th width="300" align="center" class="style5">学时</th>
          <th width="300" align="center" class="style5">学分</th>
          <th width="300"  align="center" class="style5">成绩</th>
          <th width="300" align="center" class="style5">绩点</th>
       </thead>
       </table> 
<asp:DataList ID="DataList1" runat="server" Height="300" >
    ...
    <tbody>
    <tr>
    <td width="300"><%#Eval("学期") %></td>
    <td width="300"><%#Eval("课程名") %></td>
    <td width="300"><%#Eval("学时") %></td>
    <td width="300"><%#Eval("学分") %></td>
    <td width="300"><%#Eval("成绩") %></td>
    <td width="300"><%#Eval("绩点") %></td>
    </tr>
    </tbody>
    </table>
    </ItemTemplate>

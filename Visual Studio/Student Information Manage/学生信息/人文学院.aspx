<%@ Page Language="C#" AutoEventWireup="true" CodeFile="人文学院.aspx.cs" Inherits="学生信息_人文学院" %>
...
<body>
  <section class="hbox stretch">
      ...
      <section class="vbox">
        ...
        <table id="Table1" runat="server" style="font-size: x-large">
            <thead>
                ...
                <td width="500" height="50">职工号</td>
                <td width="300" height="50">年龄</td>
                <td width="600" height="50" align="center">学院</td>
                <td width="400" height="50">所在系</td>
    ...
    <td width="500" height="50"><%#Eval("所在系") %></td>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="个人信息.aspx.cs" Inherits="学生信息_个人信息" %>
...
<body>
  <section class="hbox stretch">
    ...
    <tr><td width="400" height="50"></td><td width="400" height="50"></td></tr>
    <tr><td width="600" height="50">学号：<%#Eval("学号") %></td><td width="600" height="50">姓名：<%#Eval("姓名") %></td></tr>
    <tr><td width="600" height="50">民族：<%#Eval("民族") %></td><td width="600" height="50">性别：<%#Eval("性别") %></td></tr>
    <tr><td width="600" height="50">电话：<%#Eval("电话") %></td><td width="600" height="50">籍贯：<%#Eval("籍贯") %></td></tr>
    <tr><td width="600" height="50">学院：<%#Eval("学院") %></td><td width="600" height="50">专业：<%#Eval("专业") %></td></tr>
    <tr><td width="600" height="50">姓名：<%#Eval("姓名") %></td><td width="600" height="50">姓名：<%#Eval("姓名") %></td></tr>
    </table>
    </ItemTemplate>
    </asp:DataList>
      </section>

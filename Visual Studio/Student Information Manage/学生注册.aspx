<%@ Page Language="C#" AutoEventWireup="true" CodeFile="学生注册.aspx.cs" Inherits="注册试用" %>
    ...
    <body>
        ...
        <div class="page-container">
            ...
            <form id="Form1" action="" method="post" runat="server">
               <asp:TextBox ID="S_num" runat="server" class="username" placeholder="请输入您的学号！"></asp:TextBox>
                 ...
                 <asp:TextBox ID="zhuanye" runat="server" class="username" placeholder="请输入您的专业！"></asp:TextBox>
                 <asp:TextBox ID="banji" runat="server" class="username" placeholder="请输入您的班级！"></asp:TextBox>
                 <asp:TextBox ID="address" runat="server" class="username" placeholder="请输入您的籍贯！"></asp:TextBox>
            ...
            <asp:RequiredFieldValidator id="Validator1" runat="Server"  ControlToValidate="S_num"   
        ErrorMessage="学号必须输入" Display="Static"></asp:RequiredFieldValidator>
        <asp:RequiredFieldValidator id="RequiredFieldValidator1" runat="Server"  ControlToValidate="S_password"   
        ...
        <asp:CompareValidator id="CV" ControlToValidate="pwd"  ControlToCompare="S_password" Type="String"  

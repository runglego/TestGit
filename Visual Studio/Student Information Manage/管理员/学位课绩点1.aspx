<%@ Page Language="C#" AutoEventWireup="true" CodeFile="学位课绩点1.aspx.cs" Inherits="管理员_学位课绩点" %>
  ...
  <section class="hbox stretch">
    ...
    <section id="content">
      <section class="vbox">
        ...
        <br /><br />
         <b style="font-size: x-large">输入你想查看的同学的学位课绩点：
         <form runat="server"><asp:TextBox ID="TextBox1" runat="server"></asp:TextBox></form>
        <br /><br /><br /><br />
        <b style="font-size: x-large">该同学的学位课绩点是：<asp:Label ID="绩点" runat="server" Text=""></asp:Label></b>
      </section>

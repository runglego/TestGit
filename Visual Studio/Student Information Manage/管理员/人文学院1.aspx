<%@ Page Language="C#" AutoEventWireup="true" CodeFile="人文学院1.aspx.cs" Inherits="管理员_人文学院1" %>
  ...
  <section class="hbox stretch">
    ...
    <section id="content">
      <section class="vbox">
        ...
        <form runat="server">
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="姓名,职工号" 
                   DataSourceID="SqlDataSource1" Width="1200px" Font-Size="Large">
    <Columns>
        ...
        <asp:CommandField ShowDeleteButton="True" />
               ...
               <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                   ConnectionString="<%$ ConnectionStrings:大作业ConnectionString5 %>" 
                   DeleteCommand="DELETE FROM [人文学院] WHERE [姓名] = @姓名 AND [职工号] = @职工号" 
                   InsertCommand="INSERT INTO [人文学院] ([姓名], [职工号], [年龄], [学院], [所在系], [职位], [性别], [民族]) VALUES (@姓名, @职工号, @年龄, @学院, @所在系, @职位, @性别, @民族)" 
                   SelectCommand="SELECT * FROM [人文学院]" 
                   UpdateCommand="UPDATE [人文学院] SET [年龄] = @年龄, [学院] = @学院, [所在系] = @所在系, [职位] = @职位, [性别] = @性别, [民族] = @民族 WHERE [姓名] = @姓名 AND [职工号] = @职工号">
                   <DeleteParameters>
                   ...
                   <InsertParameters>
                       ...
                       <asp:Parameter Name="所在系" Type="String" />
               ...
               <asp:FormView ID="FormView1" runat="server" DataKeyNames="姓名,职工号" 
                   ...
                   <EditItemTemplate>
                       ...
                       <br />
                       所在系:
                       <asp:TextBox ID="所在系TextBox" runat="server" Text='<%# Bind("所在系") %>' />
                       <br />
                       职位:
                ...
                <%--   <ItemTemplate>
                       ...
                       <br />
                       所在系:
                       <asp:Label ID="所在系Label" runat="server" Text='<%# Bind("所在系") %>' />
                       <br />
                       职位:

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="物理系1.aspx.cs" Inherits="管理员_物理系1" %>
    ...
    <section id="content">
      <section class="vbox">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ConnectionString="<%$ ConnectionStrings:大作业ConnectionString7 %>" 
            DeleteCommand="DELETE FROM [物理系] WHERE [姓名] = @姓名 AND [职工号] = @职工号" 
            InsertCommand="INSERT INTO [物理系] ([姓名], [职工号], [学院], [职位], [性别], [民族]) VALUES (@姓名, @职工号, @学院, @职位, @性别, @民族)" 
            SelectCommand="SELECT * FROM [物理系]" 
            UpdateCommand="UPDATE [物理系] SET [学院] = @学院, [职位] = @职位, [性别] = @性别, [民族] = @民族 WHERE [姓名] = @姓名 AND [职工号] = @职工号">
            <DeleteParameters>

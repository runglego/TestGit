<%@ Page Language="C#" AutoEventWireup="true" CodeFile="信息科学技术学院1.aspx.cs" Inherits="管理员_信息科学技术学院1" %>
  ...
  <section class="hbox stretch">
    ...
    <section id="content">
      ...
      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            DataKeyNames="姓名,职工号" DataSourceID="SqlDataSource1" Width="1200" Font-Size="Large">
          <Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ConnectionString="<%$ ConnectionStrings:大作业ConnectionString8 %>" 
            DeleteCommand="DELETE FROM [信息院] WHERE [姓名] = @姓名 AND [职工号] = @职工号" 
            InsertCommand="INSERT INTO [信息院] ([姓名], [职工号], [学院], [职位], [性别], [民族]) VALUES (@姓名, @职工号, @学院, @职位, @性别, @民族)" 
            SelectCommand="SELECT * FROM [信息院]" 
            UpdateCommand="UPDATE [信息院] SET [学院] = @学院, [职位] = @职位, [性别] = @性别, [民族] = @民族 WHERE [姓名] = @姓名 AND [职工号] = @职工号">
            <DeleteParameters>

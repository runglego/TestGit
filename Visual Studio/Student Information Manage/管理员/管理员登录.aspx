<%@ Page Language="C#" AutoEventWireup="true" CodeFile="管理员登录.aspx.cs" Inherits="学生信息_管理员" %>
    ...
    <body>
        ...
        <div class="page-container">
            ...
            <form id="Form1" action="" method="post" runat=server>
               <asp:TextBox ID="A_num" runat="server" class="username" placeholder="请输入您的用户名！"></asp:TextBox>
                 <asp:TextBox ID="A_password" runat="server" class="password" placeholder="请输入您的密码！" TextMode="Password"></asp:TextBox>
                <asp:Button ID="Button1" runat="server" Text="登录" onclick="管理员登录" />
            </form>
        </div>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="装备学院1.aspx.cs" Inherits="管理员_装备学院1" %>
...
<body>
  ...
  <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            DataKeyNames="姓名,职工号" DataSourceID="SqlDataSource1" Width="1200px" Font-Size="Large">
      <Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ConnectionString="<%$ ConnectionStrings:大作业ConnectionString9 %>" 
            DeleteCommand="DELETE FROM [装备院] WHERE [姓名] = @姓名 AND [职工号] = @职工号" 
            InsertCommand="INSERT INTO [装备院] ([姓名], [职工号], [学院], [职位], [性别], [民族]) VALUES (@姓名, @职工号, @学院, @职位, @性别, @民族)" 
            SelectCommand="SELECT * FROM [装备院]" 
            UpdateCommand="UPDATE [装备院] SET [学院] = @学院, [职位] = @职位, [性别] = @性别, [民族] = @民族 WHERE [姓名] = @姓名 AND [职工号] = @职工号">
            <DeleteParameters>

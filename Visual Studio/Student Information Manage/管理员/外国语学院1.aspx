<%@ Page Language="C#" AutoEventWireup="true" CodeFile="外国语学院1.aspx.cs" Inherits="管理员_外国语学院1" %>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="姓名,职工号" 
                   DataSourceID="SqlDataSource1" Width="1200" Font-Size="Large">
    <Columns>
        ...
        <asp:CommandField ShowDeleteButton="True" />
               ...
               <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                   ConnectionString="<%$ ConnectionStrings:大作业ConnectionString6 %>" 
                   DeleteCommand="DELETE FROM [外国语学院] WHERE [姓名] = @姓名 AND [职工号] = @职工号" 
                   InsertCommand="INSERT INTO [外国语学院] ([姓名], [职工号], [年龄], [学院], [职位], [性别], [民族]) VALUES (@姓名, @职工号, @年龄, @学院, @职位, @性别, @民族)" 
                   SelectCommand="SELECT * FROM [外国语学院]" 
                   UpdateCommand="UPDATE [外国语学院] SET [年龄] = @年龄, [学院] = @学院, [职位] = @职位, [性别] = @性别, [民族] = @民族 WHERE [姓名] = @姓名 AND [职工号] = @职工号">
                   <DeleteParameters>
...
<asp:FormView ID="FormView1" runat="server" DataKeyNames="姓名,职工号" 
                   DataSourceID="SqlDataSource1" Width="500" Font-Size="Large">
    <EditItemTemplate>
        姓名:

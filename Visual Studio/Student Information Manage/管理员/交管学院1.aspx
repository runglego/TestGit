<%@ Page Language="C#" AutoEventWireup="true" CodeFile="交管学院1.aspx.cs" Inherits="管理员_交管学院1" %>
    ...
    <Columns>
        ...
        <asp:CommandField ShowDeleteButton="True" />
              ...
              <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                  ConnectionString="<%$ ConnectionStrings:大作业ConnectionString4 %>" 
                  DeleteCommand="DELETE FROM [交管学院] WHERE [姓名] = @姓名 AND [职工号] = @职工号" 
                  InsertCommand="INSERT INTO [交管学院] ([姓名], [职工号], [年龄], [学院], [所在系], [民族], [职位]) VALUES (@姓名, @职工号, @年龄, @学院, @所在系, @民族, @职位)" 
                  SelectCommand="SELECT * FROM [交管学院]" 
                  UpdateCommand="UPDATE [交管学院] SET [年龄] = @年龄, [学院] = @学院, [所在系] = @所在系, [民族] = @民族, [职位] = @职位 WHERE [姓名] = @姓名 AND [职工号] = @职工号">
                  <DeleteParameters>

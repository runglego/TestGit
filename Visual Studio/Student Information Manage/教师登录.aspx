<%@ Page Language="C#" AutoEventWireup="true" CodeFile="教师登录.aspx.cs" Inherits="登录" %>
    ...
    <body>
        <div class="page-container">
            ...
            <form id="Form1" action="" method="post" runat=server>
               <asp:TextBox ID="T_num" runat="server" class="username" placeholder="请输入您的用户名！"></asp:TextBox>
                 <asp:TextBox ID="T_password" runat="server" class="password" placeholder="请输入您的密码！" TextMode="Password"></asp:TextBox>
                <asp:Button ID="Button1" runat="server" Text="登录" onclick="教师登录" />
            </form>
        </div>

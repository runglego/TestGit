<%@ Page Language="C#" AutoEventWireup="true" CodeFile="学生主页.aspx.cs" Inherits="src_学生主页" %>
            ...
            <ul class="nav">
              ...
              <li class="dropdown-submenu">
                ...
                <ul class="dropdown-menu">                 
                  ...
                  <li>
                    <a href="学生信息/装备学院.aspx">装备运输与海洋学院</a>
                  </li>
                  <li>
                    <a href="学生信息/交管学院.aspx">交通运输管理学院</a>
                  </li>
                  <li>
                    <a href="学生信息/外国语学院.aspx">外国语学院</a>
                  </li>
                  <li>
                    <a href="学生信息/人文学院.aspx">人文学院</a>
                  </li>
                   <li>
                    <a href="学生信息/物理系.aspx">物理系</a>
                  </li>
                </ul>
              </li>
              <li class="dropdown-submenu">
                ...
                <ul class="dropdown-menu">                
                  <li>
                    <a href="学生信息/选课管理/选课公告.aspx">选课公告</a>                    
                  </li>
                  <li>
                    <a href="学生信息/选课管理/选课方案.aspx">选课方案</a>              
                  </li>
                  <li>
                    <a href="学生信息/选课管理/已选课程维护.aspx">已选课程维护</a>
                  </li>
                  <li>
                    <a href="学生信息/选课管理/学期课表.aspx">学期课表</a>
                  </li> 
                </ul>
              </li>
              <li class="dropdown-submenu">
                ...
                <ul class="dropdown-menu">                
                  <li>
                    <a href="学生信息/学生成绩/学生全部成绩.aspx">学生全部成绩</a>
                  </li>
                  <li>
                    <a href="学生信息/学生成绩/学位课绩点.aspx">学位课绩点</a>
                  </li>
                </ul>
              </li>
            </ul>
